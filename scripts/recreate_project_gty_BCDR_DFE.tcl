...
set project_name "10G_eth_FMC_GTY_BCDR_DFE"
...
set files [list \
 ...
 "[file normalize "$origin_dir/../sources/pon_sources/vio_config_par_wrapper.v"]"\
 "[file normalize "$origin_dir/../sources/ip_sources/vio_config_par/vio_config_par.xci"]"\
 "[file normalize "$origin_dir/../sources/ip_sources/SOPDetect_0/SOPDetect_0.xci"]"\ 
 "[file normalize "$origin_dir/../sources/pon_sources/Xg_PON_if_gty.v"]"\
 "[file normalize "$origin_dir/../sources/pon_sources/gty_BCDR_gt_wrapper_DFE.v"]"\
 "[file normalize "$origin_dir/../sources/ip_sources/gty_BCDR_DFE/gty_BCDR_DFE.xci"]"\
...
set file "[file normalize "$origin_dir/../constraints/GTH_eth_10G_to_XG_PON_GTY_DFE.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/../constraints/GTH_eth_10G_to_XG_PON_GTY_DFE.xdc"
set file [file normalize $file]
...
set run_synth_impl = "DISABLE"
if { $run_synth_impl eq "DISABLE" } {
	start_gui
} else {
	#** Run synthesis
	puts "#####*********************************************##########"
