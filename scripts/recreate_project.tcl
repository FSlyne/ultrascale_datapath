...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/../sources/ip_sources/BCDR/GTY/BCDR_QuickLock.dcp"]"\
 ...
 "[file normalize "$origin_dir/../sources/pon_sources/gty_BCDR_gt_wrapper.v"]"\
 ...
 "[file normalize "$origin_dir/../sources/pon_sources/FMC_GTH_BCDR_gtbnk230_x0y26_wrapper.v"]"\
 "[file normalize "$origin_dir/../sources/pon_sources/AXIS_TxGateway.v"]"\
 "[file normalize "$origin_dir/../sources/ip_sources/FMC_gth_BCDR_gtbnk230_x0y26_gt/FMC_gth_BCDR_gtbnk230_x0y26_gt.xci"]"\
 ...
 "[file normalize "$origin_dir/../sources/ip_sources/gty_BCDR/gty_BCDR.xci"]"\
...
#** Do not run the commands this part onwards if you wish to inspect the sources and generate the bitstream from GUI mode
#** Comment the lines this part onwards if creating the project from running the tcl file and if you want to run the synthesis in gui mode

#** Start the GUI (comment this if you want to do everything in non-gui mode, (runs faster))"
#start_gui
